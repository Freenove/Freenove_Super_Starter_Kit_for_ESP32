...
If you are using ESP32 Core 2.x.x, please see :ref:`Sketch_21.1_Bluetooth_Music_by_DAC(2.x.x) <fnk0047/codes/c/28_bluetooth_media_by_dac:sketch_21.1_bluetooth_music_by_dac(2.x.x)>`

If you are using ESP32 Core 3.x.x, please see :ref:`Sketch_21.1_Bluetooth_Music_by_DAC(3.x.x) <fnk0047/codes/c/28_bluetooth_media_by_dac:sketch_21.1_bluetooth_music_by_dac(3.x.x)>`
...
.. literalinclude:: ../../../freenove_Kit/C/Sketches/Sketch_21.1_BluetoothByDAC(2.x.x)/Sketch_21.1_BluetoothByDAC(2.x.x).ino
    :linenos: 
    :language: c
    :dedent:
...
.. literalinclude:: ../../../freenove_Kit/C/Sketches/Sketch_21.1_BluetoothByDAC(3.x.x)/Sketch_21.1_BluetoothByDAC(3.x.x).ino
    :linenos: 
    :language: c
    :lines: 1-31
    :dedent:
