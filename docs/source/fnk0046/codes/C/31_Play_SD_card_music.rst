...
In the new pop-up window, select "Freenove_Super_Starter_Kit_for_ESP32\\C\\Libraries\\ESP8266Audio.zip". 
...
In the new pop-up window, select **"Freenove_Super_Starter_Kit_for_ESP32\\C\\Libraries\\ESP32-audioI2S.zip"**. 
...
**Freenove_Super_Starter_Kit_for_ESP32\\Sketches\\Sketch_31.2_SDMMC_Music.**
