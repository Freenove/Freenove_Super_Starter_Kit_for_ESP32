...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "18.1_I2C_LCD1602". Select "I2C_LCD.py"and "LCD_API.py", right click your mouse to select "Upload to /", wait for "I2C_LCD.py" and"LCD_API.py" to be uploaded to ESP32-WROVER and then double click "I2C_LCD1602.py". 
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/18.1_IIC_LCD1602/IIC_LCD1602.py
    :language: python
    :dedent:
