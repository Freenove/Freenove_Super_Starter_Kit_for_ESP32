...
Open the "Freenove_Super_Starter_Kit_for_ESP32\\Sketches\\Sketches\\Sketch_33.1_WiFiClient\\sketchWiFi\\sketchWiFi.pde", and click "Run".
...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "22.1_TCP_as_Client" and double click "TCP_as_Client.py". 
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/22.1_TCP_as_Client/TCP_as_Client.py
    :language: python
    :dedent:

Import network、socket、time modules.

.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/21.3_AP+STA_mode/AP+STA_mode.py
    :language: python
    :lines: 1-3
    :dedent:
...
Open "Thonny", click "This computer"  ->  "D:"  ->  "Micropython_Codes"  ->  "22.2_TCP_as_Server" and double click "TCP_as_Server.py". 
...
Open the " **Freenove_Super_Starter_Kit_for_ESP32/Codes/MicroPython_Codes/22.2_TCP_as_Server/sketchWiFi/sketchWiFi.pde** ".
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/22.2_TCP_as_Server/TCP_as_Server.py
    :language: python
    :dedent:
