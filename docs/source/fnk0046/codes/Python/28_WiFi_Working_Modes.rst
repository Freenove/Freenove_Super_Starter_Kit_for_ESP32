...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/21.1_Station_mode/Station_mode.py
    :language: python
    :dedent:
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/21.2_AP_mode/AP_mode.py
    :language: python
    :dedent:
